# =============================================================================
# home.nix - Home Manager Yapılandırması (Minimal)
# =============================================================================
...

{
  ...
  programs = {
    ...
    # -----------------------------------------------------------------------
    # GIT
    # FIX: userName ve userEmail gerçek bilgilerle güncellendi.
    # GitHub/GitLab commit'lerinde bu bilgiler görünür.
    # -----------------------------------------------------------------------
    git = {
      enable    = true;
      userName  = "Umpug";
      userEmail = "umpug@users.noreply.github.com";
      extraConfig = {
        core.editor  = "nano";
        core.autocrlf = "input";
        pull.rebase  = false;
